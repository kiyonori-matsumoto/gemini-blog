...
export default async function Post({ params }: PostPageProps) {
  ...
  return (
    <article className="prose dark:prose-invert prose-teal mx-auto">
      ...
      <div className="text-gray-500 mb-4 dark:text-gray-300 text-right flex flex-row gap-x-2 justify-end">
        {new Date(postData.date).toLocaleString("ja-JP", {
          year: "numeric",
          month: "long",
          day: "numeric",
        })}
        {postData.updated && (
          <span>
            (更新:{" "}
            {new Date(postData.updated).toLocaleString("ja-JP", {
              year: "numeric",
              month: "long",
              day: "numeric",
            })}
      ...
      <div className="mt-8 flex justify-end space-x-4">
        ...
        >
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-twitter-x flex-shrink-0 group-hover:mr-2"
            viewBox="0 0 16 16"
          >
        ...
        >
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-facebook flex-shrink-0 group-hover:mr-2"
            viewBox="0 0 16 16"
          >
